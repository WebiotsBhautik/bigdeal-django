...
def canvas_filter(request, category_id=None):
    ...
    template_path = 'pages/shop/canvas-filter.html'
...
def category_filter(request, category_id=None):
    ...
    template_path = 'pages/shop/shop-category-slider.html'
...
def filter_hide(request, category_id=None):
    ...
    template_path = 'pages/shop/shop-filter-hide.html'
...
def shop_left_slidebar(request, category_id=None):
    ...
    cart_products,totalCartProducts = show_cart_popup(request)
    selected_currency = add_cookie_currency(request)
    template_path = 'pages/shop/shop-left-slidebar.html'
...
def list_infinite(request, category_id=None):
    ...
    cart_products,totalCartProducts = show_cart_popup(request)
    selected_currency = add_cookie_currency(request)
    template_path = 'pages/shop/shop-list-infinite.html'
...
def shop_list(request, category_id=None):
    ...
    cart_products,totalCartProducts = show_cart_popup(request)
    selected_currency = add_cookie_currency(request)
    template_path = 'pages/shop/shop-list.html'
...
def shop_top_filter(request, category_id=None):
    ...
    cart_products,totalCartProducts = show_cart_popup(request)
    selected_currency = add_cookie_currency(request)
    template_path = 'pages/shop/shop-top-filter.html'
...
def shop_with_category(request, category_id=None):
    ...
    cart_products,totalCartProducts = show_cart_popup(request)
    selected_currency = add_cookie_currency(request)
    template_path = 'pages/shop/shop-with-category.html'
...
def wishlist_page(request):
    ...
    if request.user.is_authenticated:
        try:
            customer_cart = Cart.objects.get(cartByCustomer=request.user)
            cart_products = CartProducts.objects.filter(cartByCustomer=request.user)
            totalCartProducts = cart_products.count()
        except Cart.DoesNotExist:
            customer_cart = None

        try:
            customer_wishlist = Wishlist.objects.get(wishlistByCustomer=request.user)
...
def validate_coupon(request):
    if request.method == 'POST':
        ...
        price = Decimal(priceStr)if priceStr is not None else Decimal('0')
        tax = Decimal(taxstr)if taxstr is not None else Decimal('0')
        finalAmountInUSD = Decimal(finalAmountInUSDStr)  if finalAmountInUSDStr is not None else Decimal('0')
