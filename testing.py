...
from .models import AttributeName, AttributeValue, ProductMeta, ProductVariant,  MultipleImages, Product, ProCategory, ProBrand, ProUnit, ProVideoProvider, ProductReview
...
class ProductAdmin(admin.ModelAdmin):
    exclude = ['slug', 'productNoOfReview', 'productStatus',
               'productRatingCount', 'productFinalRating', 'productEndDate', 'productSoldQuantity']
    # 'product_image',,'productVendor'
    list_display = ['productVendor','productName','proCategory','productType', 'productBrand', 'total_quantity','original_price','discount_percentage','discounted_price', 'productStatus', 
    ...
    def discounted_price(self, obj):
        ...
        if obj.productType == "Classified":
            ...
            if cheapest_product.productVariantFinalPrice == most_expensive_product.productVariantFinalPrice:
                return f"{cheapest_product.productVariantFinalPrice}"
            else:
    ...
    def original_price(self, obj):
        ...
        if obj.productType == "Classified":
            ...
            if cheapest_product.productVariantPrice == most_expensive_product.productVariantPrice:
                return f"{cheapest_product.productVariantPrice}"
            else:
...
#                     form=AttributeValueAdminForm,
#                     list_display=['attributeName', 'attributeValue'],
#                     exclude=['slug', 'id', 'createdAt'])
